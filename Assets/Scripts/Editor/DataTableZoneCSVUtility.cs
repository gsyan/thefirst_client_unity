...
public static class DataTableZoneCSVUtility
{
    ...
    public static void ExportGrid(DataTableZone table)
    {
        ...
        sb.AppendLine("zone_index,grid_width,grid_height,enemy_fleets,enemy_budget,enemy_max_cost,enemy_deviation,enemy_max_ships_per_fleet,enemy_stat_multiplier,exploration_point_reward,commander_exp_reward");
        foreach (ZoneConfig z in table.zoneList)
        {
            sb.AppendLine(
                $"{z.zoneIndex},{z.gridWidth},{z.gridHeight}," +
                $"{z.enemyFleetsPerCell},{z.enemyBudget},{z.enemyMaxCost},{z.enemyDeviation},{z.enemyMaxShipsPerFleet},{z.enemyStatMultiplier}," +
